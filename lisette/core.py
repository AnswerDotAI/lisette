...
# %% auto #0
__all__ = ['haik45', 'sonn45', 'sonn46', 'opus45', 'opus46', 'tool_dtls_tag', 're_tools', 'token_dtls_tag', 're_token', 'effort',
           'tc_res_sysp', 'status_re', 'patch_litellm', 'remove_cache_ckpts', 'contents', 'stop_reason', 'mk_msg',
